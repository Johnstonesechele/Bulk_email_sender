...
int main(int argc, char *argv[])
{
    ...
    // Set dark theme with blue and gold colors
    ...
    darkPalette.setColor(QPalette::BrightText, QColor(255, 215, 0)); // Gold
    darkPalette.setColor(QPalette::Link, QColor(100, 150, 255)); // Blue
    darkPalette.setColor(QPalette::Highlight, QColor(100, 150, 255)); // Blue
